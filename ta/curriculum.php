...
<!--                            <li><a href="introduction.php">个人介绍</a></li>-->
    ...
    <div class="col-md-12 main-content-timeline">
        <div class="timeline-post" style="background-image: url(../images/1832.jpg);">
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                <h4 color="#FFFFFF" style="font-size:40px;"><font >课程列表</h4>
                <div type="text" name="content0" class="form-control" style="height:700px;font-size:25px;background-size:100% 100%;background:rgba(255,255,255,0.5);overflow: hidden;" >
                    <?php
                    ...
                    echo "<table border='1' style='border:3px solid #aaa;margin:0px auto;' >

                    <tr>
                    <td style='text-align:center;width: 350px;height:50px; border:3px solid rgba(255,255,255,0.5);'>课程名称</td>
                    <td style='text-align:center;width: 400px;height:50px; border:3px solid rgba(255,255,255,0.5);'>课程介绍</td>
                    <td style='text-align:center;width: 100px;height:50px; border:3px solid rgba(255,255,255,0.5);'>邀请码</td>
                    ...
                    while($row = mysqli_fetch_array($result))
                      {
                      echo "<tr>";
                      echo "<td style='height:100px;border:3px solid rgba(255,255,255,0.5);'>" . $row['course_name'] . "</td>";
                      echo "<td style='height:100px;border:3px solid rgba(255,255,255,0.5);'>" . $row['introduction'] . "</td>";
                      echo "<td style='height:100px;border:3px solid rgba(255,255,255,0.5);'>" . $row['invitation'] . "</td>";
                     // $c = $row['course_id'];
                      //$a = "SELECT hw_name FROM homework where (tid = '$tid' and course_id = '$c')";
                     // $b = @mysqli_query($dbc, $a);
                     // $d = mysqli_fetch_array($b,MYSQLI_ASSOC);
                     // $e=implode(" ",$d);
