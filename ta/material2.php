                                ...
                                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC))//从结果集$r得到关联数组
                                {
                                    ...
                                    echo '<tr>
                                            ...
                                            <td><a style="color: white" href="../php/download_material.php?cid='.$_POST['cid'].'&cata=file&file='.$name.'" class="btn btn-success unwork_a">下载</a>
                                                <a style="color: white" href="../php/delete_material_ta.php?cid='.$_POST['cid'].'&cata=file&file='.$name.'" class="btn btn-danger unwork_a">删除</a>
                                            </td>
                                           </tr>';
                                }
                            }
                            ...
                            if($result){
                                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC))//从结果集$r得到关联数组
                                {
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>'.$time.'</td>
                                            <td>'.$size.'byte</td>
                                            <td><a style="color: white" href="../php/download_material_ta.php?cid='.$_POST['cid'].'&cata=video&file='.$name.'" class="btn btn-success unwork_a">下载</a>
                                                <a style="color: white" href="../php/delete_material_ta.php?cid='.$_POST['cid'].'&cata=video&file='.$name.'" class="btn btn-danger unwork_a">删除</a>
                                            </td>
                                           </tr>';
                                }
                            }
...
//                                    $filename=str_replace("../material/file/sem/","",$path);
                                    echo '<tr>
                                            ...
                                            <td><a style="color: white" href="../php/download_material.php?cata=sem&file='.$name.'" class="btn btn-success unwork_a">下载</a>
                                                <a style="color: white" href="../php/delete_material_ta.php?cata=sem&file='.$name.'" class="btn btn-danger unwork_a">删除</a>
                                            </td>
                                           </tr>';
                                }
                            }
...
//        alert(this.attr('href'));
    ...
    $("#uploadFile").fileinput({
        ...
        uploadUrl: "../php/file_upload_ta.php",
        uploadExtraData:{
    ...
    $("#uploadVideo").fileinput({
        language: "zh",
        uploadUrl: "../php/video_upload_ta.php",
