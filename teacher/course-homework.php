...
if(isset($_POST["hw_name"])&&isset($_POST["summary"])&&isset($_POST["deadline"]))
{
    ...
    $sql="INSERT INTO homework (hw_id,hw_name,path,summary,deadline,course_id,tid) VALUES ('$resultNum','$_POST[hw_name]','$path','$_POST[summary]','$_POST[deadline]','$_POST[cid]','".$tid."');";
