                ...
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            ...
                            <li><a href="curriculum.php">课程管理</a></li>
                        ...
                        <div class="modal-body">
									<?php
                                        if(isset($_POST['submit'])){//判断用户是否提交注册表单，如果是则执行如下代码
                                            ...
                                            $ta_right = $_POST['taright'];
                                            if ($ta_right == '-1')
                                            {
                                                echo "<script>alert('未选择助教权限！');location.href='index.php';</script>";
                                            }
                                            ...
                                            if($result){
                                                if(mysqli_num_rows($result)>0){
                                                    ...
                                                    $query = "select * from ta where aid = '$taid'";
                                                    $result = @mysqli_query($dbc, $query);
                                                    if (mysqli_num_rows($result)==0){
                                                        echo "<script>alert('找不到助教，课程创建失败！');location.href='index.php';</script>";
                                                    }
                                                    else{
                                                        ...
                                                        if($result){
                                                            if ($ta_right == '1'){
                                                                $query = "insert into ta_right(taid, course_id, modify_course_info, delete_course, delete_post, delete_replay,
                                                                post_hw, post_notice, download_hw, correct_hw, post_grade, upload_answer, delete_hw,upload_material, delete_material) 
                                                                values($taid, $course_id, false, false, false, false, true, false, true, true, true, true, true, true, true)";
                                                            }
                                                            else if ($ta_right == '2'){
                                                                $query = "insert into ta_right(taid, course_id, modify_course_info, delete_course, delete_post, delete_replay,
                                                                post_hw, post_notice, download_hw, correct_hw, post_grade, upload_answer, delete_hw,upload_material, delete_material)
                                                                values ($taid, $course_id, false, false, false, true, true, false, true, true, true, true, true, true, true)";
                                                            }
                                                            else if ($ta_right == '3'){
                                                                $query = "insert into ta_right(taid, course_id, modify_course_info, delete_course, delete_post, delete_replay,
                                                                post_hw, post_notice, download_hw, correct_hw, post_grade, upload_answer, delete_hw,upload_material, delete_material)
                                                                values ($taid, $course_id, false, false, true, true, true, true, true, true, true, true, true, true, true)";
                                                            }
                                                            else if ($ta_right == '4'){
                                                                $query = "insert into ta_right(taid, course_id, modify_course_info, delete_course, delete_post, delete_replay,
                                                                post_hw, post_notice, download_hw, correct_hw, post_grade, upload_answer, delete_hw,upload_material, delete_material) 
                                                                values ($taid, $course_id, true, true, true, true, true, true, true, true, true, true, true, true, true)";
                                                            }
                                                            $result = @mysqli_query($dbc, $query);
                            ...
                            <div class="form-group">
                                <select class="form-control" name="taright" >
                                    <option value ="-1" selected class="form-control">助教权限</option>
                                    <option value ="1">仅批改作业</option>
                                    <option value ="2">批改作业、论坛管理</option>
                                    <option value="3">批改作业、论坛管理、公告管理（推荐）</option>
